...
공부한 시간뿐 아니라 착석·자세·조도 조건을 함께 기록하는 개인용 캠스터디 웹 앱입니다. MediaPipe의 사람 존재·기준 자세 편차와 최종 Teachable Machine Pose 예측을 융합하고, 안정화된 결과만 순공 타이머 조건에 사용합니다.
...
- 자세 모델은 환경·거리·조명·사용자에 따라 오분류될 수 있으며 의료 진단이나 실제 집중력 측정에 사용하지 않습니다.
...
- Phase 6 CSV 오프라인 분석은 `python/`에 구현되어 있습니다.
